// Renders HARDHIK into a single coverage texture and reports the ink rectangle
// of every individual letter.
//
// Why a texture and not DOM text: the figure who stands inside the wordmark
...
// HARDHIK is seven letters, exactly like the wordmark the reference art was
// measured from, so every ink-box percentage in layout.js still holds.
const TEXT = 'HARDHIK';
