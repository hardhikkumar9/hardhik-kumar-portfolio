...
void main(){
  ...
  // The fine octave is 3.1x the coarse one, so it is the speckle; at the old
  // 0.42 it dominated. Weighted down, the coarse blotching leads and the
  // scratches sit under it, which is the way round the reference reads.
  float wear = mix(tex, tex2, 0.15);
