...
export const YEARS = [
  {
    year: 2021,
    key: 'Foundations',
    lines: ['B.Tech IT, Delhi', 'Java and databases', 'First systems built'],
  },
  {
    year: 2022,
    key: 'First delivery',
    lines: ['AICTE E-Governance', 'Android support app', 'Java · Firebase · REST'],
  },
  {
    year: 2023,
    key: 'Into industry',
    lines: ['Graduated, CGPA 8.5', 'Joined Nexgen Techtronics', 'Shipping to deadlines'],
  },
  {
    year: 2024,
    key: 'The analyst turn',
    lines: ['Elicited requirements', 'Wrote the specs', 'Business ↔ technical'],
  },
  {
    year: 2025,
    key: 'Birmingham',
    lines: ['MSc Business Analytics', 'BCS Agile BA certified', 'New country, new brief'],
  },
  {
    year: 2026,
    key: 'Evidence at scale',
    lines: ['Capstone BA, 5-person team', '1,878 records analysed', 'Six dashboards, one forecast'],
  },
];
