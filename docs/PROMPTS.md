...
> **This is the original Gireesh direction**, kept because the README's technical
> explanations refer back to it. The site is now Hardhik Kumar's; the creative
> direction is unchanged, the content is not. For what to generate now, read
> `FLOW-PROMPTS.md`; for what is still outstanding, `WHAT-I-NEED-FROM-YOU.md`.
...
rectangle) enters centre → the giant red distressed wordmark rises from below,
