...
CARDS = [
    # name      outline                                             depth
    ("sales", [(245, 102), (400, 123), (567, 190), (553, 315),
                  (400, 301), (243, 268)], 0.45),
    ("specs",     [(143, 281), (461, 355), (437, 490), (93, 462)], 0.25),
    ("demand",    [(597, 86), (800, 71), (1005, 82), (1007, 282),
                  (800, 299), (596, 299)], 0.60),
    ("segments",   [(1028, 205), (1362, 125), (1428, 442), (1240, 435),
                  (1030, 345)], 0.45),
    ("process",    [(424, 396), (594, 388), (596, 516), (426, 526)], 0.80),
    ("defects",    [(598, 398), (709, 394), (711, 532), (599, 537)], 0.90),
    ("weather",     [(728, 400), (879, 396), (876, 536), (731, 540)], 1.00),
    ("water",   [(874, 406), (1009, 400), (1006, 542), (876, 546)], 0.90),
    ("aicte",    [(1018, 404), (1189, 394), (1187, 534), (1020, 542)], 0.80),
    ("forecast",     [(1211, 350), (1471, 281), (1506, 453), (1219, 463)], 0.30),
    ("night",  [(148, 504), (290, 497), (431, 535), (433, 669),
                  (163, 680)], 0.10),
    ("uat",    [(1169, 528), (1427, 508), (1434, 665), (1318, 682),
                  (1175, 670)], 0.10),
]
